...
def post_list_view(request,tag_slug=None):
    ...
    paginator=Paginator(post_list,2) #no. of content want
    ...
    return render(request,'blog/blog_post.html',{'post_list':post_list,'tag':tag})
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject,message,'p2k17k@gmail.com',[cd['to']])
            sent=True
